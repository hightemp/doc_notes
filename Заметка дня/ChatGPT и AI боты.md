...
- напиши 30 сетевых утилит которые существуют в linux
	Конечно, вот список 30 сетевых утилит в Linux:
	
	1.  ping - для проверки доступности хоста в сети
	2.  traceroute - для определения маршрута до удаленного хоста
	3.  netstat - для просмотра сетевых соединений и статистики
	4.  ss - для отображения информации о сокетах
	5.  ifconfig - для настройки сетевых интерфейсов и просмотра их текущего состояния
	6.  ip - для настройки сетевых интерфейсов и просмотра их текущего состояния
	7.  tcpdump - для захвата сетевого трафика
	8.  nmap - для сканирования портов и определения открытых служб на удаленном хосте
	9.  ssh - для защищенного удаленного доступа к хосту
	10.  scp - для защищенной копировки файлов между хостами
	11.  curl - для выполнения HTTP-запросов
	12.  wget - для загрузки файлов из Интернета
	13.  dig - для выполнения DNS-запросов и отображения информации о доменных именах
	14.  host - для преобразования доменных имен в IP-адреса и наоборот
	15.  arp - для отображения таблицы ARP
	16.  route - для настройки маршрутов и просмотра текущих маршрутов
	17.  iptables - для настройки и управления правилами межсетевого экрана
	18.  tcpdump - для захвата и анализа сетевого трафика
	19.  ngrep - для захвата и анализа сетевого трафика с использованием регулярных выражений
	20.  iperf - для тестирования пропускной способности сети
	21.  mtr - для комбинирования функций ping и traceroute
	22.  hping - для отправки кастомизированных пакетов в сеть
	23.  whois - для получения информации о владельцах доменных имен и IP-адресов
	24.  ethtool - для настройки и просмотра параметров Ethernet-интерфейсов
	25.  iwconfig - для настройки и просмотра параметров беспроводных сетей
	26.  3proxy - для настройки прокси-сервера
	27.  mailx - для отправки электронной почты из командной строки
	28.  lynx - для просмотра веб-страниц из командной строки
	29.  w3m - для просмотра веб-страниц и изображений из командной строки
	30.  elinks - для просмотра веб-страниц, изображений и PDF-файлов из командной строки.
- напиши все сетевые утилиты которые существуют в linux
	Существует много сетевых утилит в Linux, но вот некоторые из них:
	
	1.  ping - для проверки связи с удаленным хостом
	2.  traceroute - для определения маршрута пакетов в сети
	3.  netstat - для отображения сетевых соединений, открытых портов, маршрутов и других сетевых статистических данных
	4.  ifconfig - для конфигурирования и отображения информации о сетевых интерфейсах
	5.  ip - для управления IP-адресами, маршрутизацией и другими сетевыми параметрами
	6.  arp - для отображения таблицы ARP, содержащей сопоставления IP- и MAC-адресов
	7.  tcpdump - для захвата и анализа сетевого трафика
	8.  nmap - для сканирования портов и определения открытых служб на удаленном хосте
	9.  ssh - для защищенного удаленного доступа к хосту
	10.  scp - для защищенной копировки файлов между хостами
	11.  curl - для выполнения HTTP-запросов
	12.  wget - для загрузки файлов из Интернета.
- распиши для нужна утилита - tcpdump
...
- распиши для нужна утилита - nethogs
